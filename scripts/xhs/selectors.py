...
CONTENT_EDITOR = "div.ql-editor, div.tiptap.ProseMirror, div.ProseMirror"
IMAGE_PREVIEW = ".img-preview-area .pr"
PUBLISH_BUTTON = ".publish-page-publish-btn button.bg-red"

# 标题/正文长度校验
TITLE_MAX_SUFFIX = "div.max_suffix"
...
# 添加地点
LOCATION_DROPDOWN = ".address-card-select .d-select-content"
LOCATION_INPUT = ".address-card-select input"
LOCATION_OPTIONS = ".address-card-select .d-options-wrapper .d-grid-item"

# 内容类型声明
CONTENT_TYPE_DROPDOWN = ".d-select-wrapper.custom-select-44 .d-select-content"
CONTENT_TYPE_OPTIONS = ".d-select-wrapper.custom-select-44 .d-options-wrapper .d-grid-item"

# 加入合集
COLLECTION_TRIGGER = ".collection-plugin-content"
COLLECTION_CREATE = ".collection-plugin-content .create-collection"
